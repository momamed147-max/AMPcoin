...
const PATHS = {
  ...
  users: (<g><circle cx="9" cy="8" r="3" /><path d="M3.5 19a5.5 5.5 0 0 1 11 0M16 5.5a3 3 0 0 1 0 5.8M17 14a5 5 0 0 1 3.5 5" /></g>),
  ...
  rpsRock: (<g><path d="M6.3 10.2 8.6 7.8a2 2 0 0 1 2.8 0l.8.8V6.2a1.7 1.7 0 0 1 3.4 0v2.1a1.7 1.7 0 0 1 3.1.8v.6a1.7 1.7 0 0 1 2.1 2.4l-1.2 4.1a3.2 3.2 0 0 1-3.1 2.3H9.3a3 3 0 0 1-2.2-1L4.4 14a1.8 1.8 0 0 1 1.9-3.8Z" /><path d="M11 12.2h.1M14.3 12.2h.1M17.2 13h.1" /></g>),
  rpsPaper: (<g><path d="M8 12.5V6.2a1.6 1.6 0 0 1 3.2 0v4.3-5.8a1.6 1.6 0 0 1 3.2 0v5.8-4.5a1.6 1.6 0 0 1 3.2 0v6.8c0 4.1-2.4 6.2-6 6.2h-.8c-2.4 0-3.8-1.3-5-2.8l-2.1-2.7a1.7 1.7 0 0 1 2.6-2.2l2.7 2.4" /></g>),
  rpsScissors: (<g><circle cx="7" cy="7" r="2.5" /><circle cx="7" cy="17" r="2.5" /><path d="m9.1 8.6 9.4 5.1M9.1 15.4 18.5 10M14.5 13.7l2.2 5.1" /></g>),
